...
//        User test3 = new User("TestTransactional3", "TestTransactional4@domain.com", LocalDate.now()); //ejemplo dos
    ...
    private void saveUsersInDb() {
        ...
        User user7 = new User("Test3", "Test3@domain.com", LocalDate.of(2021, 1, 13));
        User user8 = new User("Test4", "Test4@domain.com", LocalDate.of(2021, 6, 24));
        User user9 = new User("Test5", "Test5@domain.com", LocalDate.of(2021, 4, 12));
